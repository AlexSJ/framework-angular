...
class Routers {
	...
	public static function controle()
	{
		 ...
		 */
		if (!$controle) {
			$controle = \framework\php\config\Framework::$defaultController;
		}
		 ...
		 */
		if (!file_exists('framework/php/controllers/' . $controle . '.php')) {
			$controle = \framework\php\config\Framework::$defaultController404;
		}
